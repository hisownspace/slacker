...
from app.s3_helpers import upload_image_file_to_s3, get_unique_filename, image_file, remove_file_from_s3
...
def get_workspaces():
  ...
  return { "workspaces": workspace.to_dict() for workspace in workspaces }, 200
